...
// @DATE:Sat May 11 13:55:39 CEST 2013
...
// @LINE:9
private[this] lazy val controllers_Application_authenticateUser3 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("authenticate/user/"))))
        

// @LINE:12
private[this] lazy val controllers_UsersReport_reportHelp4 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("client/report/help"))))
        

// @LINE:13
private[this] lazy val controllers_UsersReport_reportDanger5 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("client/report/danger"))))
        

// @LINE:14
private[this] lazy val controllers_UsersReport_reportDetails6 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("client/report/details"))))
        

// @LINE:15
private[this] lazy val controllers_UsersReport_reportPhoto7 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("client/report/photo"))))
        

// @LINE:16
private[this] lazy val controllers_UsersReport_getInfo8 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("client/info/"),DynamicPart("lat", """[^/]+"""),StaticPart("/"),DynamicPart("lon", """[^/]+"""))))
        

// @LINE:19
private[this] lazy val controllers_UserInformationRequest_getInfoFeed9 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("client/news"))))
        

// @LINE:22
private[this] lazy val controllers_AdminCommunication_createDistrict10 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("admin/district/"))))
        

// @LINE:23
private[this] lazy val controllers_AdminCommunication_modifyDistrict11 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("admin/district/"))))
        

// @LINE:24
private[this] lazy val controllers_AdminCommunication_deleteDistrict12 = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("admin/district/"),DynamicPart("id", """[^/]+"""))))
        

// @LINE:25
private[this] lazy val controllers_AdminCommunication_listAllDistricts13 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("admin/district/"))))
        

// @LINE:26
private[this] lazy val controllers_AdminCommunication_getDistrict14 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("admin/district/"),DynamicPart("id", """[^/]+"""))))
        

// @LINE:29
private[this] lazy val controllers_DistrictCommunication_postInformation15 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("district/information/"))))
        

// @LINE:30
private[this] lazy val controllers_DistrictCommunication_updateInformation16 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("district/information/"))))
        

// @LINE:31
private[this] lazy val controllers_DistrictCommunication_deleteInformation17 = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("district/information/"),DynamicPart("id", """[^/]+"""))))
        

// @LINE:32
private[this] lazy val controllers_DistrictCommunication_getAllInformations18 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("district/"),DynamicPart("idDistrict", """[^/]+"""))))
        

// @LINE:33
private[this] lazy val controllers_DistrictCommunication_getInformation19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("district/"),DynamicPart("id", """[^/]+"""))))
        

// @LINE:34
private[this] lazy val controllers_DistrictCommunication_initWebSocket20 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("district/websocket/"),DynamicPart("id", """[^/]+"""))))
        

// @LINE:37
private[this] lazy val controllers_Assets_at21 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("assets/"),DynamicPart("file", """.+"""))))
        
def documentation = List(("""GET""", prefix,"""controllers.Application.index()"""),("""PUT""", prefix + (if(prefix.endsWith("/")) "" else "/") + """authenticate/district/""","""controllers.Application.authenticateDistrict()"""),("""PUT""", prefix + (if(prefix.endsWith("/")) "" else "/") + """authenticate/admin/""","""controllers.Application.authenticateAdmin()"""),("""PUT""", prefix + (if(prefix.endsWith("/")) "" else "/") + """authenticate/user/""","""controllers.Application.authenticateUser()"""),("""POST""", prefix + (if(prefix.endsWith("/")) "" else "/") + """client/report/help""","""controllers.UsersReport.reportHelp()"""),("""POST""", prefix + (if(prefix.endsWith("/")) "" else "/") + """client/report/danger""","""controllers.UsersReport.reportDanger()"""),("""POST""", prefix + (if(prefix.endsWith("/")) "" else "/") + """client/report/details""","""controllers.UsersReport.reportDetails()"""),("""POST""", prefix + (if(prefix.endsWith("/")) "" else "/") + """client/report/photo""","""controllers.UsersReport.reportPhoto()"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """client/info/$lat<[^/]+>/$lon<[^/]+>""","""controllers.UsersReport.getInfo(lat:Double, lon:Double)"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """client/news""","""controllers.UserInformationRequest.getInfoFeed(lat:Long, lon:Long, oldest:Long)"""),("""POST""", prefix + (if(prefix.endsWith("/")) "" else "/") + """admin/district/""","""controllers.AdminCommunication.createDistrict()"""),("""PUT""", prefix + (if(prefix.endsWith("/")) "" else "/") + """admin/district/""","""controllers.AdminCommunication.modifyDistrict()"""),("""DELETE""", prefix + (if(prefix.endsWith("/")) "" else "/") + """admin/district/$id<[^/]+>""","""controllers.AdminCommunication.deleteDistrict(id:Long)"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """admin/district/""","""controllers.AdminCommunication.listAllDistricts()"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """admin/district/$id<[^/]+>""","""controllers.AdminCommunication.getDistrict(id:Long)"""),("""POST""", prefix + (if(prefix.endsWith("/")) "" else "/") + """district/information/""","""controllers.DistrictCommunication.postInformation()"""),("""PUT""", prefix + (if(prefix.endsWith("/")) "" else "/") + """district/information/""","""controllers.DistrictCommunication.updateInformation()"""),("""DELETE""", prefix + (if(prefix.endsWith("/")) "" else "/") + """district/information/$id<[^/]+>""","""controllers.DistrictCommunication.deleteInformation(id:Long)"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """district/$idDistrict<[^/]+>""","""controllers.DistrictCommunication.getAllInformations(idDistrict:Long)"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """district/$id<[^/]+>""","""controllers.DistrictCommunication.getInformation(id:Long)"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """district/websocket/$id<[^/]+>""","""controllers.DistrictCommunication.initWebSocket(id:Long)"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """assets/$file<.+>""","""controllers.Assets.at(path:String = "/public", file:String)""")).foldLeft(List.empty[(String,String,String)]) { (s,e) => e match {
...
// @LINE:9
case controllers_Application_authenticateUser3(params) => {
   call { 
        invokeHandler(controllers.Application.authenticateUser(), HandlerDef(this, "controllers.Application", "authenticateUser", Nil,"PUT", """""", Routes.prefix + """authenticate/user/"""))
   }
}
        

// @LINE:12
case controllers_UsersReport_reportHelp4(params) => {
   call { 
...
// @LINE:13
case controllers_UsersReport_reportDanger5(params) => {
   call { 
...
// @LINE:14
case controllers_UsersReport_reportDetails6(params) => {
   call { 
...
// @LINE:15
case controllers_UsersReport_reportPhoto7(params) => {
   call { 
...
// @LINE:16
case controllers_UsersReport_getInfo8(params) => {
...
// @LINE:19
case controllers_UserInformationRequest_getInfoFeed9(params) => {
...
// @LINE:22
case controllers_AdminCommunication_createDistrict10(params) => {
   call { 
...
// @LINE:23
case controllers_AdminCommunication_modifyDistrict11(params) => {
   call { 
...
// @LINE:24
case controllers_AdminCommunication_deleteDistrict12(params) => {
...
// @LINE:25
case controllers_AdminCommunication_listAllDistricts13(params) => {
   call { 
...
// @LINE:26
case controllers_AdminCommunication_getDistrict14(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:29
case controllers_DistrictCommunication_postInformation15(params) => {
   call { 
...
// @LINE:30
case controllers_DistrictCommunication_updateInformation16(params) => {
   call { 
...
// @LINE:31
case controllers_DistrictCommunication_deleteInformation17(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:32
case controllers_DistrictCommunication_getAllInformations18(params) => {
...
// @LINE:33
case controllers_DistrictCommunication_getInformation19(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:34
case controllers_DistrictCommunication_initWebSocket20(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        invokeHandler(controllers.DistrictCommunication.initWebSocket(id), HandlerDef(this, "controllers.DistrictCommunication", "initWebSocket", Seq(classOf[Long]),"GET", """""", Routes.prefix + """district/websocket/$id<[^/]+>"""))
   }
}
