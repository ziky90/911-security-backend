...
// @LINE:36
private[this] lazy val controllers_Application_verifyDistrict22 = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("district/verify/"))))
...
// @LINE:36
case controllers_Application_verifyDistrict22(params) => {
   call { 
        invokeHandler(controllers.Application.verifyDistrict(), HandlerDef(this, "controllers.Application", "verifyDistrict", Nil,"PUT", """""", Routes.prefix + """district/verify/"""))
   }
}
